...
- Analise o novo formato da duração e identifique a necessidade de atualização no parsing (Ref. Ex. anterior).
...
- Modularize o código criando métodos separados para cada tipo de filtro (títulos com duas palavras, músicas que iniciam e terminam com a mesma palavra).
